...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      svc_collect_income: { Args: { _user_id: string }; Returns: number }
      svc_complete_mpesa_deposit: {
        Args: {
          _amount: number
      ...
      svc_purchase_package: {
        Args: { _package_id: number; _user_id: string }
        Returns: string
      }
      svc_request_withdrawal: {
